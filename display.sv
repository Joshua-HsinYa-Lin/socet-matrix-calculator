module display #(
    ...
    input  logic [2:0]  prompt_type,  // 0: NONE/DATA, 1: ROW, 2: COL, 3: ADD, 4: MUL, 5: TRA, 6: R_C_ (Coord)
    ...
    always_comb begin
        ...
        case (prompt_type)
            3'd0: begin // Show BCD Data
                ss7 = decode_bcd(display_data[31:28]);
                ss6 = decode_bcd(display_data[27:24]);
                ss5 = decode_bcd(display_data[23:20]);
                ss4 = decode_bcd(display_data[19:16]);
            ...
            3'd6: begin // "r X c Y " (Coordinate Entry)
                ss7 = CHAR_R; 
